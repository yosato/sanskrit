...
'cv':(
    ...
    [ sanskrit_phon.Vowels, 'k', 'g', 'c', 'j', 'ṭ', 'ḍ', 't', 'd', 'p', 'b', ('m','n'), ('y', 'v'), 'r', 'l', 'ś', ('ṣ','s'), 'h'],

    {
    ('k',): ('g', 'k','g','k','g','k', 'g','k', 'g', 'k', 'g', 'ṅ', 'g', 'g', 'g','k','k', ('gg h', 'g gh')),
    ('ṭ',): ('ḍ', 'ṭ', 'ḍ', 'ṭ', 'ḍ', 'ṭ', 'ḍ', 'ṭ', 'ḍ', 'ṭ', 'ḍ', 'ṇ', 'ḍ','ḍ', 'ḍ', 'ṭ', 'ṭ', ('ḍḍ h', 'ḍ ḍh')),
    ('t',): ('d', 't', 'd', 't', 'd', 't', 'd', 't', 'd', 't', 'd', 'n', 'd', 'd', 'l', ' cch', 't', ('dd h', 'd dh')),
    ('p',): ('b', 'p', 'b', 'p', 'b','p', 'b','p', 'b', 'p', 'b', 'm', 'b', 'b', 'b', 'p', 'p', ('bb h', 'b bh')),
    ('ṅ',): (('ṅṅ', 'ṅ'), 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ', 'ṅ'),
    ('n',): (('nn','n'), 'n','n','ṃś', 'ñ', 'ṃṣ', 'ṇ', 'ṃs', 'n', 'n', 'n', 'n', 'n', 'n', 'ṃl', ('ñ ś','ñ ch'), 'n', 'n'),
